...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_2_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_2_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1.4_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1.4_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_0.7_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_0.7_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_0.5_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_0.5_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
%     \begin{subtable}{0.5\textwidth}
%     \input{results/p2.0_50_1_1h/output/mean_table.tex}
%     \caption[]{Means} 
%     \end{subtable}%
%     \begin{subtable}{0.5\textwidth}
%     \input{results/p2.0_50_1_1h/output/std_table.tex}
%     \caption[]{Standard deviations} 
%     \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p2.0_100_1_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p2.0_100_1_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.0_100_1_1h/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.0_100_1_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \end{subtable}
    \begin{subtable}{0.5\textwidth}
    \input{results/p0.7_100_1_1h/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_1/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_1/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_2/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_2/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_3/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_3/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_4/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/unif_100_1_2h_4/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_1s/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_1s/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_2s/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_2s/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_3s/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_3s/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
...
\scriptsize
    ...
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_4s/output/mean_table.tex}
    \caption[]{Means} 
    \end{subtable}%
    \begin{subtable}{0.5\textwidth}
    \input{results/p1.4_100_1_1h_4s/output/std_table.tex}
    \caption[]{Standard deviations} 
    \end{subtable}
