...
\begin{table}[htbp]
    ...
    \begin{tabular}{ll}
        ...
        \bottomrule
    \end{tabular}
    \caption[Parameters used for varying the peak of the single-peak risk function]
        {Parameters used for varying the peak of the single-peak risk function with \glspl{factor} 100 and the peak of the single-peak population of 10,000}
