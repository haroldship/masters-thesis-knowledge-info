...
The results of the second group are found in \Cref{sec:results:pop_spread,sec:results:p1.4_Gap_risk} while the results of the first group comprise the remainder.
