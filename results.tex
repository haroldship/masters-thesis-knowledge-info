...
\Cref{sec:results:setup} below describes how the configuration of the experimental setup.
...
The rest of this chapter examines the effect of different variables on the \gls{dkd} accuracy,
