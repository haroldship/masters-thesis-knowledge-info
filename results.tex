...
We saw in \Cref{sec:theory:accuracy} that the bias, and hence the \gls{mse} of a kernel estimate at a point depends on $\lambda^{\prime \prime}$, the second deriviative of the true intensity.
