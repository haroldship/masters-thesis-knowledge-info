...
described in \Cref{sec:theory:bandwidth}.
...
We saw in \Cref{sec:theory:bias_variance} that the bias, and hence the \gls{mse} of a kernel estimate at a point depends on $\lambda^{\prime \prime}$, the second deriviative of the true intensity.
