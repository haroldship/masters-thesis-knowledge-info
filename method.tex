...
In this chapter, we describe the methods used to examine the statistical performance of the DKD.
...
\Cref{sec:method_experiment_structure} describes the steps of each experiment, together with the measurements taken.

\section{Experiment structure}
\label{sec:method_experiment_structure}

Each experiment begins by setting the random number seed to the same fixed value (12).
