...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{One-dimensional \glsentryname{kernel} functions using the biweight(quartic) kernel \citep{silverman1986density}.
...
The number of events $n$ can increase in several ways: for example, if the time period of the study is increased,
