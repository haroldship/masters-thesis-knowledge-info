...
In order to do this,
we choose the biweight kernel because it is more computationally efficient than the Gaussian kernel,
and has higher differentiablity than the Epanechnikov kernel \citep[p. 77]{silverman1986density}.
\textcolor{red}{tbd put a table above when discussing kernels and refer to it here.}
