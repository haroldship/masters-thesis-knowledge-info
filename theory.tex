...
In our case,
the \glspl{incident} are members of the population that have something happen to them such as falling ill.
Therefore,
we generate \glspl{incident} by applying the incidence rate to a pre-generated population.
