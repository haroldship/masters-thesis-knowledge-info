%latex.default(df.alpha, title = "nmise_convergence_table", where = "htbp",     label = "tab:results:nmise_convergence_by_num_cases", rowname = NULL,     cdec = c(0, 3), caption.loc = "bottom", caption = "NMISE onvergence rate by number of cases for different bandwidth selectors for a single-peak risk function with spread of 1.0 on a uniform population of 10,000.",     caption.lot = "NMISE Convergence rate by number of cases for spread 1.0")%
\begin{table}[htbp]
\begin{center}
\begin{tabular}{lr}
\hline\hline
