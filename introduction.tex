...
\begin{question}
    ...
    \begin{subquestions}
        \item the size of the population, \label[theorem]{thm:accuracy-affected:popsize}%
        \item the duration of the study, \label[theorem]{thm:accuracy-affected:duration}%
        \item different rate functions, \label[theorem]{thm:accuracy-affected:rates}%
        \item and different population distributions. \label[theorem]{thm:accuracy-affected:popdist}%
    \end{subquestions}
\end{question}
...
\begin{question}
    ...
    \begin{subquestions}
        \item globally, over the study area as a whole, \label[theorem]{thm:accuracy-scale:global}%
        \item and pointwise at the peaks. \label[theorem]{thm:accuracy-scale:peaks}%
    \end{subquestions}
\end{question}
